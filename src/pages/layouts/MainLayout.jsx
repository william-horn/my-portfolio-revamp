...
const MainLayout = ({ title, children }) => {
    ...
    const randomId = () => {
        ...
        console.log('standard render:', id)
        return id;
    }

    return (
        <section ref={pageSectionDiv} className='fade-in page-section text-center center-wide col-9 mg-7-top mg-4-top-all mg-10-bottom'>
